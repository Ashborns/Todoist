...
const yt2api = {
  ...
  async get_task(hash) {
    return await this.request('https://music.yt2api.com/api/json', { hash }).then(response => response.data);
  },

  async progress_task(taskId) {
    return await this.request('https://music.yt2api.com/api/json/task', { taskId }).then(response => response.data);
  },
